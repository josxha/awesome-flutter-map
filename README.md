...
| Last update | Links | flutter_map version |
| ----------- | ----- | ------------------- |
| Mon, May 6, 2024 | [pub.dev](https://pub.dev/packages/flutter_map_marker_cluster)  [GitHub](https://github.com/lpongetti/flutter_map_marker_cluster) | >=6.0.0 <7.0.0 |
...
```yaml
power_geojson: ^1.0.7+13
```
| Last update | Links | flutter_map version |
| ----------- | ----- | ------------------- |
| Sun, Mar 3, 2024 | [pub.dev](https://pub.dev/packages/power_geojson)  [GitHub](https://github.com/ymrabti/power_geojson) | ^6.1.0 |
### vector_mbtiles
