...
| Last update | Links | flutter_map version |
| ----------- | ----- | ------------------- |
| Fri, Apr 18, 2025 | [pub.dev](https://pub.dev/packages/flutter_map_cache)  [GitHub](https://github.com/josxha/flutter_map_plugins) | >=6.0.0 <9.0.0 |
...
| Last update | Links | flutter_map version |
| ----------- | ----- | ------------------- |
| Sun, Feb 15, 2026 | [pub.dev](https://pub.dev/packages/power_geojson)  [GitHub](https://github.com/youmtinetflutterpacks/power_geojson) | ^8.2.2 |
### vector_mbtiles
