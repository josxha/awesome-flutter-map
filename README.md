...
```yaml
flutter_map_location_marker: ^7.0.5
```
| Last update | Links | flutter_map version |
| ----------- | ----- | ------------------- |
| Wed, Sep 13, 2023 | [pub.dev](https://pub.dev/packages/flutter_map_location_marker)  [GitHub](https://github.com/tlserver/flutter_map_location_marker) | <span style="color:red">^5.0.0 (not latest)</span> |
